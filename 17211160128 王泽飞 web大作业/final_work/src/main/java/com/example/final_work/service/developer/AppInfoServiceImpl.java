...
import com.example.final_work.dao.appinfo.AppInfoMapper;
import com.example.final_work.dao.appversion.AppVersionMapper;
...
public class AppInfoServiceImpl implements AppInfoService {
	...
	@Override
	public List<AppInfo> countbysoftname() {
		return mapper.countbysoftname();
	}
