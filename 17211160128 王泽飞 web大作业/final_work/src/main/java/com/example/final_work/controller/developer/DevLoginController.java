...
import com.example.final_work.service.developer.DevUserService;
...
public class DevLoginController {
	...
	public String doLogin(@RequestParam String devCode, @RequestParam String devPassword, HttpServletRequest request, HttpSession session) throws Exception {
		...
		if(null != user){//登录成功
			//放入session
			session.setAttribute("devinfo", devUserService.login(devCode,devPassword));
			session.setAttribute("devinfoid", devUserService.login(devCode,devPassword).getId());
